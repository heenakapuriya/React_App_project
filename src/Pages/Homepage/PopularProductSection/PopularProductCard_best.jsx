                    ...
                    <div className='flex justify-center'>
                        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-20 xl:gap-16 2xl:gap-10 mt-10'>
                            ...
                            {data.filter((el) => { return el.type === 'best selling' }).map((ele) => {
                                return (
                                    <div className='main-product-card h-[350px] w-[290px] mt-5'>
                                        <div className='bg-[#F6F8FA] h-[350px] w-[290px] relative'>
                                            ...
                                            <div className='h-40 w-12 z-5 three-icon right-0  mt-8 absolute'>
                                                <div className='h-10 heart w-10  bg-white mt-2 shadow-md border  hover:bg-custom-pink rounded-sm'><i className="fa-regular fa-heart text-xl pt-1 ps-2 text-gray-700 hover:text-white "></i></div>
                                                <div className='h-10 eye w-10  bg-white mt-3 shadow-md border  hover:bg-custom-pink hover:text-white rounded-sm'><i className="fa-regular fa-eye text-xl pt-1 ps-2 text-gray-700 hover:text-white duration-500"></i></div>
                                                <div className='h-10 chain w-10  bg-white mt-3 shadow-md border  hover:bg-custom-pink hover:text-white rounded-sm'>
                                                    <i className="fa-solid fa-link text-xl hover:text-white pt-1 ps-2 text-gray-700 "></i></div>
                                            </div>
...
export default PopularProductCard_best